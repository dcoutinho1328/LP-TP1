...
\\032\000\012\000\035\000\011\000\036\000\010\000\038\000\009\000\
...
\\032\000\012\000\035\000\011\000\036\000\010\000\038\000\009\000\
\\042\000\048\000\043\000\047\000\044\000\046\000\045\000\008\000\000\000\
\\001\000\005\000\022\000\008\000\021\000\010\000\020\000\011\000\019\000\
\\012\000\018\000\013\000\017\000\014\000\016\000\017\000\015\000\
\\028\000\014\000\030\000\013\000\032\000\012\000\035\000\011\000\
\\036\000\010\000\038\000\009\000\041\000\123\000\045\000\008\000\000\000\
\\001\000\005\000\022\000\008\000\021\000\010\000\020\000\011\000\019\000\
\\012\000\018\000\013\000\017\000\014\000\016\000\017\000\015\000\
\\028\000\014\000\030\000\013\000\032\000\012\000\035\000\011\000\
\\036\000\010\000\038\000\009\000\045\000\008\000\000\000\
...
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\025\000\028\000\026\000\027\000\
\\034\000\111\000\039\000\110\000\000\000\
\\001\000\015\000\038\000\016\000\037\000\017\000\036\000\018\000\035\000\
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\025\000\028\000\026\000\027\000\
...
\\001\000\020\000\136\000\040\000\082\000\000\000\
\\001\000\026\000\051\000\028\000\080\000\029\000\079\000\042\000\048\000\
\\043\000\047\000\044\000\046\000\000\000\
\\001\000\026\000\051\000\028\000\080\000\042\000\048\000\043\000\047\000\
\\044\000\046\000\000\000\
\\001\000\026\000\083\000\029\000\107\000\037\000\106\000\040\000\082\000\000\000\
\\001\000\026\000\083\000\040\000\082\000\000\000\
\\001\000\027\000\095\000\000\000\
\\001\000\027\000\102\000\000\000\
\\001\000\027\000\108\000\040\000\082\000\000\000\
...
\\001\000\029\000\107\000\037\000\106\000\040\000\082\000\000\000\
\\001\000\029\000\118\000\000\000\
\\001\000\031\000\081\000\000\000\
\\001\000\033\000\075\000\000\000\
\\001\000\034\000\111\000\039\000\110\000\000\000\
\\001\000\038\000\063\000\000\000\
\\001\000\040\000\082\000\045\000\097\000\000\000\
...
\\194\000\000\000\
\\195\000\000\000\
\\196\000\040\000\082\000\000\000\
\\197\000\000\000\
\\198\000\000\000\
\\199\000\000\000\
\\200\000\000\000\
\\201\000\037\000\106\000\040\000\082\000\000\000\
\\202\000\000\000\
\"
...
\\005\000\001\000\038\000\075\000\
\\074\000\035\000\005\000\005\000\
\\005\000\005\000\005\000\005\000\
\\005\000\005\000\005\000\005\000\
...
EXCLAMARK1left, _)) :: rest671)) => let val  result = MlyValue.Expr
 (fn _ => let val  (Expr as Expr1) = Expr1 ()
 in (Prim1("!", Expr))
end)
 in ( LrTable.NT 2, ( result, EXCLAMARK1left, Expr1right), rest671)
...
|  ( 26, ( ( _, ( _, _, DIRCOLCH1right)) :: ( _, ( MlyValue.NAT NAT1,
 ...
 in ( LrTable.NT 2, ( result, Expr1left, DIRCOLCH1right), rest671)
end
...
|  ( 30, ( ( _, ( _, _, DIRPAREN1right)) :: ( _, ( MlyValue.Comps 
Comps1, _, _)) :: ( _, ( _, ESQPAREN1left, _)) :: rest671)) => let
 val  result = MlyValue.AtomExpr (fn _ => let val  (Comps as Comps1) =
 Comps1 ()
 in (List(Comps))
end)
 in ( LrTable.NT 3, ( result, ESQPAREN1left, DIRPAREN1right), rest671)

end
|  ( 31, ( ( _, ( _, _, DIRPAREN1right)) :: ( _, ( MlyValue.Expr Expr1
, _, _)) :: ( _, ( _, ESQPAREN1left, _)) :: rest671)) => let val  
result = MlyValue.AtomExpr (fn _ => let val  (Expr as Expr1) = Expr1
 ()
 in (Expr)
end)
 in ( LrTable.NT 3, ( result, ESQPAREN1left, DIRPAREN1right), rest671)
...
|  ( 38, ( ( _, ( _, _, DIRPAREN1right)) :: ( _, ( _, ESQPAREN1left, _
)) :: rest671)) => let val  result = MlyValue.Const (fn _ => (List [])
)
 in ( LrTable.NT 5, ( result, ESQPAREN1left, DIRPAREN1right), rest671)

end
|  ( 39, ( ( _, ( _, _, DIRPAREN1right)) :: _ :: _ :: ( _, ( 
MlyValue.Type Type1, _, _)) :: ( _, ( _, ESQPAREN1left, _)) :: rest671
)) => let val  result = MlyValue.Const (fn _ => let val  (Type as 
Type1) = Type1 ()
 in (ESeq(Type))
end)
 in ( LrTable.NT 5, ( result, ESQPAREN1left, DIRPAREN1right), rest671)
...
|  ( 44, ( ( _, ( _, DASH1left, DASH1right)) :: rest671)) => let val  
result = MlyValue.CondExpr (fn _ => (NONE))
 in ( LrTable.NT 8, ( result, DASH1left, DASH1right), rest671)
end
...
|  ( 46, ( ( _, ( _, _, DIRPAREN1right)) :: ( _, ( _, ESQPAREN1left, _
)) :: rest671)) => let val  result = MlyValue.Args (fn _ => ([]))
 in ( LrTable.NT 9, ( result, ESQPAREN1left, DIRPAREN1right), rest671)

end
|  ( 47, ( ( _, ( _, _, DIRPAREN1right)) :: ( _, ( MlyValue.Params 
Params1, _, _)) :: ( _, ( _, ESQPAREN1left, _)) :: rest671)) => let
...
|  ( 52, ( ( _, ( _, _, DIRPAREN1right)) :: ( _, ( MlyValue.Types 
Types1, _, _)) :: ( _, ( _, ESQPAREN1left, _)) :: rest671)) => let
 val  result = MlyValue.Type (fn _ => let val  (Types as Types1) = 
Types1 ()
 in (ListT(Types))
end)
 in ( LrTable.NT 12, ( result, ESQPAREN1left, DIRPAREN1right), rest671
)
end
|  ( 53, ( ( _, ( _, _, DIRCOLCH1right)) :: ( _, ( MlyValue.Type Type1
, _, _)) :: ( _, ( _, ESQCOLCH1left, _)) :: rest671)) => let val  
result = MlyValue.Type (fn _ => let val  (Type as Type1) = Type1 ()
 in (SeqT(Type))
end)
 in ( LrTable.NT 12, ( result, ESQCOLCH1left, DIRCOLCH1right), rest671
)
end
...
|  ( 58, ( ( _, ( _, _, DIRPAREN1right)) :: ( _, ( MlyValue.Type Type1
, _, _)) :: ( _, ( _, ESQPAREN1left, _)) :: rest671)) => let val  
result = MlyValue.AtomType (fn _ => let val  (Type as Type1) = Type1
 ()
 in (Type)
end)
 in ( LrTable.NT 13, ( result, ESQPAREN1left, DIRPAREN1right), rest671
)
end
...
ParserData.MlyValue.VOID,p1,p2))
fun EXCLAMARK (p1,p2) = Token.TOKEN (ParserData.LrTable.T 9,(
ParserData.MlyValue.VOID,p1,p2))
...
ParserData.MlyValue.VOID,p1,p2))
fun ESQCOLCH (p1,p2) = Token.TOKEN (ParserData.LrTable.T 25,(
ParserData.MlyValue.VOID,p1,p2))
fun DIRCOLCH (p1,p2) = Token.TOKEN (ParserData.LrTable.T 26,(
ParserData.MlyValue.VOID,p1,p2))
fun ESQPAREN (p1,p2) = Token.TOKEN (ParserData.LrTable.T 27,(
ParserData.MlyValue.VOID,p1,p2))
fun DIRPAREN (p1,p2) = Token.TOKEN (ParserData.LrTable.T 28,(
ParserData.MlyValue.VOID,p1,p2))
fun ESQCHAVE (p1,p2) = Token.TOKEN (ParserData.LrTable.T 29,(
ParserData.MlyValue.VOID,p1,p2))
fun DIRCHAVE (p1,p2) = Token.TOKEN (ParserData.LrTable.T 30,(
ParserData.MlyValue.VOID,p1,p2))
...
ParserData.MlyValue.VOID,p1,p2))
fun NAT (i,p1,p2) = Token.TOKEN (ParserData.LrTable.T 37,(
ParserData.MlyValue.NAT (fn () => i),p1,p2))
fun BAR (p1,p2) = Token.TOKEN (ParserData.LrTable.T 38,(
ParserData.MlyValue.VOID,p1,p2))
fun ARROW (p1,p2) = Token.TOKEN (ParserData.LrTable.T 39,(
ParserData.MlyValue.VOID,p1,p2))
fun DASH (p1,p2) = Token.TOKEN (ParserData.LrTable.T 40,(
ParserData.MlyValue.VOID,p1,p2))
